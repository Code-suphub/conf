...
if __name__ == '__main__':
    ...
    file_name,args = common.get_file_name(args,"AlgoOnlyBatch",f"__rho2[{rho2}]_cmp",alpha)
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        for idx, a in enumerate(fl_lst):
            if a == 1:
                print("FL：ind:", idx, '---------------- batch_size_lst: ', algo.batch_size_lst[idx], '------------',len(sample_data[idx]), '--------------', len(user_groups))
