...
class LocalUpdate(object):
    ...
    def update_weights(self, model, global_round,local_weights=None,local_losses=None,i=-1):
        ...
        local_weights[i] = copy.deepcopy(model.state_dict())
        local_losses[i] = sum(epoch_loss) / len(epoch_loss)
